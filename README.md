...
- [Migration to Gatsby v2 - Variable "$slug" of required type "String!" was not provided](https://dev.to/rajeshroyal/migration-to-gatsby-v2-variable-slug-of-required-type-string-was-not-provided-4bg6)
- [How to use GraphQL in WordPress – Best Alternative to Rest API](https://dev.to/rajeshroyal/how-to-use-graphql-in-wordpress-best-alternative-to-rest-api-40j6)
- [How to learn 4 technologies at a time?](https://dev.to/rajeshroyal/how-to-learn-4-technologies-at-a-time-3ioe)
