...
- [I informed my boss that three different companies were pursuing me](https://dev.to/rajeshroyal/i-informed-my-boss-that-three-different-companies-were-pursuing-me-3jf7)
- [Modern JavaScript Project Workflow/Setup with Git, CI/CD, Code Quality, Tooling and more](https://dev.to/rajeshroyal/modern-javascript-project-workflow-setup-with-git-ci-cd-code-quality-tooling-and-more-33nm)
- [4 Crazy Ideas to Make Windows 10 Run Faster within 8 minutes 🚀🚀](https://dev.to/rajeshroyal/4-crazy-ideas-to-make-windows-10-run-faster-within-8-minutes-3p6h)
- [How To live-reload 🔄 Node-js server along with Hot🥵Reloading](https://dev.to/rajeshroyal/how-to-live-reload-node-js-server-along-with-hot-reloading-2im0)
- [Fixed Render-blocking JQuery in WordPress with Autoptimize](https://dev.to/rajeshroyal/fixed-render-blocking-jquery-in-wordpress-with-autoptimize-8jp)
<!-- BLOG-POST-LIST:END -->
